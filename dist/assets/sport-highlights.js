...
define('sport-highlights/components/component-favorite', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    store: _ember['default'].inject.service(),
    actions: {
      deleteFromFavorites: function deleteFromFavorites(favorite) {
        this.get('store').findRecord('favorite', favorite.id, { backgroundReload: false }).then(function (favorite) {
...
define('sport-highlights/components/component-highlight', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    store: _ember['default'].inject.service(),
    auth: _ember['default'].inject.service(),
    isHidden: false,
    ...
    actions: {
      addToFavorites: function addToFavorites(highlight) {
        var _this = this;
        ...
        this.get('store').createRecord('favorite', {
          ...
          _this.get('flashMessages').success('Added Highlight to Favorites!');
        })['catch'](function () {
          _this.get('flashMessages').danger('Failed To Add To Favorites. Please Try again!');
        });
      }
    }
  });
});
define('sport-highlights/components/component-search', ['exports', 'ember', 'sport-highlights/config/environment'], function (exports, _ember, _sportHighlightsConfigEnvironment) {
  exports['default'] = _ember['default'].Component.extend({
    search: '',
    store: _ember['default'].inject.service(),
    actions: {
      doSearch: function doSearch() {
        ...
        _ember['default'].$.ajax({
          url: _sportHighlightsConfigEnvironment['default'].apiHost + '/highlights?query=' + this.get('search')
        }).then(function (data) {
          _this.set('search', '');
          _this.set('highlights', data);
        });
      }
    }
  });
...
define('sport-highlights/models/favorite', ['exports', 'ember-data'], function (exports, _emberData) {
  exports['default'] = _emberData['default'].Model.extend({
    title: _emberData['default'].attr('string'),
    date: _emberData['default'].attr('string'),
    video_id: _emberData['default'].attr('string'),
...
define('sport-highlights/routes/favorites', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
...
define("sport-highlights/templates/components/component-favorite", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "6cvbUtZ2", "block": "{\"statements\":[[\"open-element\",\"a\",[]],[\"static-attr\",\"target\",\"_blank\"],[\"dynamic-attr\",\"href\",[\"concat\",[\"http://youtube.com/watch?v=\",[\"unknown\",[\"favorite\",\"video_id\"]]]]],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"open-element\",\"img\",[]],[\"dynamic-attr\",\"src\",[\"concat\",[[\"unknown\",[\"favorite\",\"image\"]]]]],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"favorite\",\"title\"]],false],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"favorite\",\"date\"]],false],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"button\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"deleteFromFavorites\",[\"get\",[\"favorite\"]]]],[\"flush-element\"],[\"text\",\"Delete\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "sport-highlights/templates/components/component-favorite.hbs" } });
});
define("sport-highlights/templates/components/component-highlight", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "K54KyYwH", "block": "{\"statements\":[[\"block\",[\"unless\"],[[\"get\",[\"isHidden\"]]],null,1]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"      \"],[\"open-element\",\"button\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"addToFavorites\",[\"get\",[\"highlight\"]]]],[\"flush-element\"],[\"text\",\"Add To Favorites\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"li\",[]],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"target\",\"_blank\"],[\"dynamic-attr\",\"href\",[\"concat\",[\"http://youtube.com/watch?v=\",[\"unknown\",[\"highlight\",\"id\"]]]]],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"open-element\",\"img\",[]],[\"dynamic-attr\",\"src\",[\"concat\",[[\"unknown\",[\"highlight\",\"snippet\",\"data\",\"thumbnails\",\"default\",\"url\"]]]]],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"highlight\",\"snippet\",\"data\",\"title\"]],false],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"highlight\",\"snippet\",\"data\",\"publishedAt\"]],false],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"get\",[\"isAuthenticated\"]]],null,0],[\"text\",\"  \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "sport-highlights/templates/components/component-highlight.hbs" } });
});
define("sport-highlights/templates/components/component-search", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "mrpvWeTI", "block": "{\"statements\":[[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"form\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"doSearch\"],[[\"on\"],[\"submit\"]]],[\"flush-element\"],[\"append\",[\"helper\",[\"input\"],null,[[\"value\",\"placeholder\"],[[\"get\",[\"search\"]],\"Search for your favorite NHL team highlights\"]]],false],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"open-element\",\"ul\",[]],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"highlights\"]]],null,0],[\"text\",\"  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"    \"],[\"append\",[\"helper\",[\"component-highlight\"],null,[[\"highlight\"],[[\"get\",[\"highlight\"]]]]],false],[\"text\",\"\\n\"]],\"locals\":[\"highlight\"]}],\"hasPartials\":false}", "meta": { "moduleName": "sport-highlights/templates/components/component-search.hbs" } });
});
...
define("sport-highlights/templates/favorites", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "YcDacbKR", "block": "{\"statements\":[[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Favorites\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"open-element\",\"ul\",[]],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"model\"]]],null,0],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"li\",[]],[\"flush-element\"],[\"append\",[\"helper\",[\"component-favorite\"],null,[[\"favorite\"],[[\"get\",[\"favorite\"]]]]],false],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"favorite\"]}],\"hasPartials\":false}", "meta": { "moduleName": "sport-highlights/templates/favorites.hbs" } });
});
define("sport-highlights/templates/index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "pt5To/tO", "block": "{\"statements\":[[\"append\",[\"unknown\",[\"component-search\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "sport-highlights/templates/index.hbs" } });
});
